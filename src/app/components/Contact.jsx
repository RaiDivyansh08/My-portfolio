...
const Contact = ({isDarkMode}) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "0225ec1b-902f-4b8f-9b3a-9959b842c556");
  ...
  return (
    <motion.div
     ...
     initial={{opacity:0}}
      ...
      style={{
        backgroundImage:isDarkMode ?'none' : `url("${assets.footer_bg_color.src}")`,
    ...
    >
      ...
      onSubmit={onSubmit}className='max-w-2xl mx-auto '>
        ...
        type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-teansparent dark:border-[0.5px]  dark:hover:bg-darkHover'>Submit now<Image src={assets.right_arrow_white} alt='' className='w-4'/></motion.button>
